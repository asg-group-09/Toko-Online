                    ...
                    <center>
                        <form method="POST" action="proseskategori.php">
                            <div class="form-group col-3 mt-4">
                                <label for="namaproduk"><b> Nama Kategori</label></b>
                                <input type="nama" class="form-control" name="nama_kategori">
                            </div>

                            <button type="submit" class="btn btn-primary ml-3" value="kategori" name="kategori" />Tambah Kategori</button>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="hapuskategori.php?id_kategori=<?php echo $data['id_kategori']; ?>" onclick="return confirm('Apakah anda yakin?')"> <i class="fas fa-trash" style="color:red;"></i></a>
                                                    </td>
