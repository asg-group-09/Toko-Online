                                    ...
                                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                        <thead>
                                            <tr style="background-color: #26b34d;">
                                                ...
                                                <th style="color: white;">Nomer Telepon</th>
                                                <th style="color: white;">List Barang</th>
                                        ...
                                        <tbody>
                                            <?php $nomor = 1; ?>
                                            <?php $query = mysqli_query($koneksi, "SELECT * FROM checkout ORDER BY id_checkout DESC");
                                            while ($data = mysqli_fetch_array($query)) { ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo $data['nomer_tlpn'] ?></td>
                                                    <td><?php echo $data['list_barang'] ?></td>
                                                    <td><?php echo $data['total_pembelian'] ?></td>
                                                    <td><?php echo $data['Tanggal_pembelian'] ?></td>
                                                    <td>
                                                        <a href=""> <span class="badge badge-warning">Sudah Bayar?</span></a>
                                                    </td>
                                                </tr>
                                                <?php $nomor++ ?>
                                            <?php } ?>
